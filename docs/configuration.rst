...
Tahoe-LAFS has multiple backend storage options. Clients will, in general, be
unaware of the particular backend being used by any given server node.

Local Disk

    The default is to store shares on the local disk (in
